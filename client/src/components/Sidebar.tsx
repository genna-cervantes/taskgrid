...
import taskanLogo from '../../public/taskan_logo.png'
      ...
      <div className="absolute left-0 top-0 z-20 w-[3.25rem] h-full flex flex-col justify-between items-center pt-2 pb-6 dark:bg-backgroundDark border-[1px] dark:border-faintWhite/5 ">
        <div className="flex flex-col gap-y-4 items-center">
          <span className="px-1 py-2" title="home">
            <Link to="/"><img src={taskanLogo} className="h-5 w-5" /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="kanban view">
            <Link to="/"><SquareKanban className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="calendar view">
            <Link to="/"><Calendar className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="filter">
            <Link to="/"><Funnel className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="chat with KanifyAI">
            <Link to="/"><MessageSquare className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="integrations">
            <Link to="/"><Blocks className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
          <span className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="share">
            <Link to="/"><ExternalLink className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
          </span>
        </div>
        <button onClick={() => setToggleSidebar(!toggleSidebar)} className="px-1 py-2 group hover:bg-faintWhite rounded-md" title="share">
          <ArrowRight className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} />
        </button>
      </div>
    );
  } else {
      ...
      <div className="fixed inset-0 z-50 bg-black/50" onClick={() => setToggleSidebar(false)}>
        ...
        <div className="flex flex-col gap-y-4 items-center w-full">
          <span className="flex gap-x-2 items-center w-[90%] px-2 py-2 group hover:bg-faintWhite/10 rounded-md" title="home">
            <Link to="/"><House className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
        ...
        <button onClick={() => setToggleSidebar(false)} className="flex gap-x-2 items-center w-[90%] px-2 py-2 group hover:bg-faintWhite/10 rounded-md" title="home">
            <Link to="/"><ArrowLeft className="group-hover:text-white/90 text-midWhite h-4" strokeWidth={2} /></Link>
