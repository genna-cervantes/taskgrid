...
const ProjectBlock = ({p, handleClickOptions, editModal, dropdownRef, setEditProjectModal}: {p: {
    id: string;
    name: string;
}, handleClickOptions: (id: string) => void,
editModal: string, dropdownRef: React.RefObject<HTMLDivElement | null>, setEditProjectModal: React.Dispatch<React.SetStateAction<boolean>>}) => {
  return (
