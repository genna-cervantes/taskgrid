  ...
  if (type === 'block'){
    ...
    return (
      <button onClick={() => setAddModal(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-plus-icon lucide-plus text-[#464646] hover:text-white/70"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
      </button>
    )
  }
};
