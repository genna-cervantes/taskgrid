    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity-50 bg-lmBackground dark:bg-backgroundDark text-light dark:text-fadedWhite border border-faintWhite/30 dark:border-faintWhite/10",
