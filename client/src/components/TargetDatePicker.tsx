    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          data-empty={!date}
          className={`flex justify-between shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] text-white/80 gap-x-1 w-full text-left font-normal bg-transparent dark:bg-transparent ${isPage ? "text-base" : "text-sm"} border-none text-light dark:text-white px-0 py-1 min-h-0 h-9`}
        >
